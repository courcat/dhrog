...
<div onclick='game.build(building.windmill); ui.close();' class='button_lg windmill'>Windmill</div>
...
<div onclick='game.build(building.digsite); ui.close();' class='button_lg digsite'>Digsite</div>
<div onclick='game.build(building.mine); ui.close();' class='button_lg mine'>Mine</div>
<div onclick='game.build(building.researchCenter); ui.close();' class='button_lg researchCenter'>ResearchCenter</div>
<div onclick='game.build(building.stables); ui.close();' class='button_lg stables'>Stables</div>
...
<script>
  ...
  win_getSupplies(building.windmill);
  win_getSupplies(building.tower);
  win_getSupplies(building.castle);
  win_getSupplies(building.mill);
	win_getSupplies(building.researchCenter);
	win_getSupplies(building.digsite);
	win_getSupplies(building.mine);
  win_getSupplies(building.stables);
...
<div onclick='game.train(unit.scout); ui.close();' class='button_lg scout'>Scout</div>
...
mod.first = `
	...
	<span class='ui_title'>Next Player</span><br>
	  Please pass the device to the next player if applicable.<br><br>
    Your multiplayer game ID is<span id='mpid-span'> sill being set up. Please wait...</span><br><br>
		<span class="button button_main" onclick="ui.back();">I am the new Heir to this Magical Box</span>
`;
